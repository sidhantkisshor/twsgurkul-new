...
const JournalPreview: React.FC = () => {
    ...
    return (
        <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF1E0]">
            <div className="max-w-4xl mx-auto">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="bg-[#FAF8F5] rounded-xl p-5 sm:p-6 border border-[rgba(44,53,57,0.08)] shadow-sm"
                >
                    <div className="flex items-center gap-3 mb-6">
                        <FileText className="w-8 h-8 text-[#C87533]" />
                        <h3 className="text-2xl font-sans font-bold text-[#2C3539]">Trading Journal Preview</h3>
                    </div>

                    {!isViewing ? (
                        <div className="text-center space-y-4">
                            <p className="text-[#2C3539]/70">
                                See how our students track and improve their trades with our proven journal system
                            </p>
                            <motion.button
                                onClick={handleViewJournal}
                                className="inline-flex items-center gap-2 px-6 py-3 bg-[#9A5A1A] text-white font-semibold rounded-lg hover:bg-[#7A4815] hover:shadow-lg transition-all"
                        ...
                        >
                            ...
                            <div className="bg-[#2C3539]/5 rounded-lg p-4 border border-[#0A8D7A]/20">
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                        <Calendar className="w-4 h-4 text-[#2C3539]/70" />
                                        <span className="text-sm text-[#2C3539]/70">15 Nov 2024</span>
                                    </div>
                            ...
                            <div className="bg-[#2C3539]/5 rounded-lg p-4 border border-[#E5484D]/20">
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                        <Calendar className="w-4 h-4 text-[#2C3539]/70" />
                                        <span className="text-sm text-[#2C3539]/70">14 Nov 2024</span>
                                    </div>
                            ...
                            <div className="mt-6 p-4 bg-[#C87533]/5 rounded-lg border border-[#C87533]/20">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 text-sm">
                                    <div>
                                        <span className="text-[#2C3539]/70">Win Rate:</span>
                                        <span className="text-[#2C3539] ml-2">68%</span>
                                    </div>
                                    <div>
                                        <span className="text-[#2C3539]/70">Avg Win/Loss:</span>
                                        <span className="text-[#0A8D7A] ml-2">2.3:1</span>
                                    </div>
                                    <div>
                                        <span className="text-[#2C3539]/70">Total Trades:</span>
                                        <span className="text-[#2C3539] ml-2">47</span>
                                    </div>
                                    <div>
                                        <span className="text-[#2C3539]/70">Net P&L:</span>
