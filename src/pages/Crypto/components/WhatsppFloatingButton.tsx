...
const WhatsppFloatingButton: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            >
                <motion.button 
                    className="bg-transparent text-[#25D366] p-4 rounded-full shadow-lg relative border border-white"
...
export default WhatsppFloatingButton;
