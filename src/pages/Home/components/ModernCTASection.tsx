      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="glass-effect rounded-2xl sm:rounded-3xl border border-white/20 p-8 sm:p-12 md:p-16 text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a
              href="#programs"
              className="group bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-full px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base md:text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-green-500/25 flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="glass-effect hover:bg-white/10 text-white rounded-full px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base md:text-lg font-semibold transition-all duration-300 border border-white/20 hover:border-white/30"
            >
              Follow @twsgurukul
            </a>
          </div>
